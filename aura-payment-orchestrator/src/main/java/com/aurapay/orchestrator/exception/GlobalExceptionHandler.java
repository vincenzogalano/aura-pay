package com.aurapay.orchestrator.exception;
...
@Slf4j
@Component("orchestratorGlobalExceptionHandler")
    ...
    private HttpStatus determineHttpStatus(String errorCodeStr) {
        ...
        try {
            ...
            return switch (errorCode) {
                ...
                case DOMAIN_RULE_VIOLATION, EXPIRED_CARD, INSUFFICIENT_FUNDS, SUSPECTED_FRAUD -> HttpStatus.UNPROCESSABLE_ENTITY;
                case VALIDATION_FAILED -> HttpStatus.BAD_REQUEST;
                case BANK_UNAVAILABLE, VAULT_SERVICE_UNAVAILABLE -> HttpStatus.SERVICE_UNAVAILABLE;
